...
var MapsLayout3 = (function () {
    ...
    MapsLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'maps-layout-3',template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/components/maps/layout-3/maps.html"*/'<!-- #Theme Google Maps - Full Screen Views -->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title *ngIf="data != null">{{data.headerTitle}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<!--Content -->\n\n<ion-content>\n\n  <div header-section *ngIf="data != null">\n\n    <!-- Content Big Title -->\n\n    <h1 header-title no-margin padding-left text-wrap>{{data.title}}</h1>\n\n  </div>\n\n  <agm-map *ngIf="data != null" [latitude]="data.map.lat" [longitude]="data.map.lng" [zoom]="data.map.zoom" [mapTypeControl]="data.map.mapTypeControl"\n\n    [streetViewControl]="data.map.streetViewControl">\n\n    <agm-marker [latitude]="data.map.lat" [longitude]="data.map.lng">\n\n    </agm-marker>\n\n  </agm-map>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/components/maps/layout-3/maps.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], MapsLayout3);
    return MapsLayout3;
