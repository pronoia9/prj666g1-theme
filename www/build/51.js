...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tab_page_10__ = __webpack_require__(900);
...
var TabPage10Module = (function () {
    ...
    TabPage10Module = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__tab_page_10__["a" /* TabPage10 */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__tab_page_10__["a" /* TabPage10 */]
            ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_toast_service__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_tabs_service__ = __webpack_require__(662);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TabPage10 = (function () {
    ...
    TabPage10 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/pages/tab-page-10/tab-page-10.html"*/'<!--- Settings TAB lauout-10 -->\n\n<ion-content>\n\n    <ion-grid no-padding *ngIf="params != null">\n\n        <ion-row>\n\n            <ion-col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 tabPage10 *ngFor="let item of params.items; let i = index;" (click)="onItemClick(item)">\n\n                <ion-card text-left>\n\n                    <div card-image>\n\n                        <img [src]="item.cardImage" />\n\n                        <ion-badge ion-fixed item-end class="badge-dark">{{item.price}}</ion-badge>\n\n                        <!-- Share Button -->\n\n                        <button ion-fixed item-end ion-button button-action-shit (click)="onShare(item, $event)">\n\n                          <ion-icon name="{{item.shareIcon}}"></ion-icon>\n\n                        </button>\n\n                    </div>\n\n                    <!--Card descriptiom-->\n\n                    <ion-card-content>\n\n                        <ion-card-title>\n\n                            <h2 card-title>{{item.title}}</h2>\n\n                            <h1 card-subtitle>{{item.subtitle}}</h1>\n\n                            <p card-body-text>{{item.description}}</p>\n\n                        </ion-card-title>\n\n                    </ion-card-content>\n\n                </ion-card>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/pages/tab-page-10/tab-page-10.html"*/,
