...
var ActionSheetLayout2Module = (function () {
    ...
    ActionSheetLayout2Module = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__action_sheet_layout_2__["a" /* ActionSheetLayout2 */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__action_sheet_layout_1__ = __webpack_require__(866);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__elastic_header_elastic_header_module__ = __webpack_require__(663);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_details_action_sheet__ = __webpack_require__(872);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_action_sheet_layout_1_action_sheet_layout_1_module__ = __webpack_require__(615);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_action_sheet_layout_2_action_sheet_layout_2_module__ = __webpack_require__(548);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_action_sheet_layout_3_action_sheet_layout_3_module__ = __webpack_require__(549);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemDetailsPageActionSheetModule = (function () {
    ...
    ItemDetailsPageActionSheetModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__item_details_action_sheet__["a" /* ItemDetailsPageActionSheet */]),
...
var ActionSheetLayout3 = (function () {
    ...
    ActionSheetLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'action-sheet-layout-3',template:/*ion-inline-start:"/Users/xoxo/Downloads/prj666-g1/src/components/action-sheet/layout-3/action-sheet.html"*/'<!-- Theme Action Sheet - With Text Header -->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n          <ion-icon name="menu"></ion-icon>\n\n        </button>\n\n    <ion-title *ngIf="data != null">{{data.headerTitle}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<!-- List Content -->\n\n<ion-content>\n\n  <ion-grid no-padding *ngIf="data != null">\n\n    <ion-row *ngIf="data != null">\n\n      <!-- Cards Full Image-->\n\n      <ion-col col-12 col-sm-6 col-lg-4 *ngFor="let item of data.items;let i = index">\n\n          <ion-card>\n\n            <ion-item no-lines no-padding>\n\n              <!-- Card Categoty-->\n\n              <span new-category text-uppercase>{{item.category}}</span>\n\n              <!-- Card Title-->\n\n              <h2 card-title>{{item.title}}</h2>\n\n              <!-- Card Subtitle-->\n\n              <h3 card-subtitle>{{item.subtitle}}</h3>\n\n              <!-- Card Action Sheet Button-->\n\n              <button item-end ion-button button-action-shit (click)="presentActionSheet(data)">\n\n                  <ion-icon name="{{data.shareIcon}}"></ion-icon>\n\n              </button>\n\n            </ion-item>\n\n            <!-- Card Big Image-->\n\n            <div big-images (click)="onEvent(\'onItemClick\', item, $event)">\n\n              <img images-filter [src]="item.image" />\n\n            </div>\n\n          </ion-card>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/prj666-g1/src/components/action-sheet/layout-3/action-sheet.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */]])
    ], ActionSheetLayout3);
...
var ItemDetailsPageActionSheet = (function () {
    ...
    ItemDetailsPageActionSheet = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/xoxo/Downloads/prj666-g1/src/pages/item-details-action-sheet/item-details-action-sheet.html"*/'<!--Action Sheet components-->\n\n<action-sheet-layout-1 *ngIf="params.actionSheetLayout1" [data]="params.data | async" [events]="params.events">\n\n</action-sheet-layout-1>\n\n\n\n<action-sheet-layout-2 *ngIf="params.actionSheetLayout2" [data]="params.data | async" [events]="params.events">\n\n</action-sheet-layout-2>\n\n\n\n<action-sheet-layout-3 *ngIf="params.actionSheetLayout3" [data]="params.data | async" [events]="params.events">\n\n</action-sheet-layout-3>'/*ion-inline-end:"/Users/xoxo/Downloads/prj666-g1/src/pages/item-details-action-sheet/item-details-action-sheet.html"*/
        }),
