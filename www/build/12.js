...
var RangeLayout3 = (function () {
    ...
    RangeLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'range-button-layout-3',template:/*ion-inline-start:"/Users/xoxo/Downloads/prj666-g1/src/components/range/layout-3/range.html"*/'<!-- RANGE COMPONENTS - With perdefined steps -->\n\n<ion-list no-margin *ngIf="data != null">\n\n    <ion-list-header no-lines no-margin text-uppercase>\n\n        <p ion-text>{{data.title}}</p>\n\n        <ion-badge item-end>{{data.value}}</ion-badge>\n\n    </ion-list-header>\n\n    <ion-item>\n\n        <ion-range [min]="data.min" [max]="data.max" [step]="data.step" snaps="true" (ionChange)="onEvent(\'onChange\', data.value, $event)" [(ngModel)]="data.value">\n\n            <ion-label range-left span-small>{{data.textLeft}}</ion-label>\n\n            <ion-label range-right span-large>{{data.textRight}}</ion-label>\n\n        </ion-range>\n\n    </ion-item>\n\n</ion-list>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/prj666-g1/src/components/range/layout-3/range.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], RangeLayout3);
    return RangeLayout3;
...
var RangeLayout4 = (function () {
    ...
    RangeLayout4 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'range-button-layout-4',template:/*ion-inline-start:"/Users/xoxo/Downloads/prj666-g1/src/components/range/layout-4/range.html"*/'<!-- RANGE COMPONENTS - Two sliders -->\n\n<ion-list no-margin *ngIf="data != null">\n\n    <ion-list-header no-lines no-margin text-uppercase>\n\n        <p ion-text>{{data.title}}</p>\n\n    </ion-list-header>\n\n    <ion-item>\n\n        <ion-range dualKnobs="true" pin="true" [(ngModel)]="data.value" (ionChange)="onEvent(\'onChange\', data.value, $event)">\n\n            <ion-label range-left span-large>{{data.textLeft}}</ion-label>\n\n            <ion-label range-right span-large>{{data.textRight}}</ion-label>\n\n        </ion-range>\n\n    </ion-item>\n\n</ion-list>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/prj666-g1/src/components/range/layout-4/range.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], RangeLayout4);
    return RangeLayout4;
