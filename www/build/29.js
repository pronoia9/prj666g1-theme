...
var ItemDetailsPageSubImageGallery = (function () {
    ...
    ItemDetailsPageSubImageGallery = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/pages/item-details-sub-image-gallery/item-details-sub-image-gallery.html"*/'<!--Sub-gallery components-->\n\n<ion-header>\n\n    <ion-navbar>\n\n        <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n        <ion-title>sub-gallery</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <div header-section>\n\n        <h1 header-title no-margin padding-left text-capitalize>{{params.data.title}}</h1>\n\n    </div>\n\n    <sub-image-gallery [data]="params.data" [events]="params.events"></sub-image-gallery>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/pages/item-details-sub-image-gallery/item-details-sub-image-gallery.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
