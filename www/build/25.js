...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__check_box_layout_1__ = __webpack_require__(801);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__check_box_layout_3__ = __webpack_require__(867);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_details_check_box__ = __webpack_require__(874);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_check_box_layout_2_check_box_layout_2_module__ = __webpack_require__(551);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_check_box_layout_3_check_box_layout_3_module__ = __webpack_require__(616);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemDetailsPageCheckBoxModule = (function () {
    ...
    ItemDetailsPageCheckBoxModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__item_details_check_box__["a" /* ItemDetailsPageCheckBox */]),
...
var CheckBoxLayout2 = (function () {
    ...
    CheckBoxLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'check-box-layout-2',template:/*ion-inline-start:"/Users/xoxo/Downloads/prj666-g1/src/components/check-box/layout-2/check-box.html"*/'<!--Themes With avatar -->\n\n<ion-content>\n\n  <ion-grid no-padding *ngIf="data != null">\n\n    <ion-row>\n\n      <ion-col col-12 no-padding>\n\n        <!-- Header Title Top -->\n\n        <ion-list-header header-section>\n\n          <h1 header-title text-capitalize>{{data.title}}</h1>\n\n        </ion-list-header>\n\n        <!-- Content List -->\n\n        <ion-list>\n\n          <ion-item border no-lines *ngFor="let item of data.items" (tap)="onEvent(\'onButton\', item)">\n\n            <!-- Content  Avatar-->\n\n            <div gradient item-start>\n\n              <img images-filter [src]="item.image">\n\n            </div>\n\n            <!-- Content Title -->\n\n            <ion-label padding-top item-title>{{item.title}}</ion-label>\n\n            <!-- Content Subtitle -->\n\n            <ion-label item-subtitle>{{item.subtitle}}</ion-label>\n\n            <ion-checkbox item-end [checked]="item.isChecked"></ion-checkbox>\n\n          </ion-item>\n\n        </ion-list>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/prj666-g1/src/components/check-box/layout-2/check-box.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], CheckBoxLayout2);
...
var CheckBoxLayout3 = (function () {
    ...
    CheckBoxLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'check-box-layout-3',template:/*ion-inline-start:"/Users/xoxo/Downloads/prj666-g1/src/components/check-box/layout-3/check-box.html"*/'<!--Themes With avatar -->\n\n<ion-content>\n\n  <ion-grid no-padding *ngIf="data != null">\n\n    <ion-row>\n\n      <ion-col col-12>\n\n        <!-- Header Title Top -->\n\n        <ion-list-header header-section>\n\n          <h1 header-title text-capitalize>{{data.title}}</h1>\n\n        </ion-list-header>\n\n        <!-- Content List -->\n\n        <ion-list>\n\n          <ion-item border no-lines *ngFor="let item of data.items" (tap)="onEvent(\'onButton\', item)">\n\n            <div item-start>\n\n              <!-- Content Title -->\n\n              <h2 item-title no-margin>{{item.title}}</h2>\n\n              <!-- Content Subtitle -->\n\n              <h3 item-subtitle no-margin>{{item.subtitle}}</h3>\n\n            </div>\n\n            <ion-label item-subtitle item-end text-right>{{item.detail}}</ion-label>\n\n            <ion-checkbox item-end [checked]="item.isChecked"></ion-checkbox>\n\n          </ion-item>\n\n        </ion-list>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/prj666-g1/src/components/check-box/layout-3/check-box.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], CheckBoxLayout3);
