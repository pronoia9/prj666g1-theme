...
var TabPage5 = (function () {
    ...
    TabPage5 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/xoxo/Downloads/prj666-g1/src/pages/tab-page-5/tab-page-5.html"*/'<!--- Settings TAB lauout-5 -->\n\n<ion-content>\n\n    <ion-list tabPage5 *ngIf="params != null">\n\n        <ion-item border no-lines *ngFor="let item of params.items; let i = index;" (click)="onItemClick(item)">\n\n            <ion-avatar item-start>\n\n                <img [src]="item.avatar" />\n\n            </ion-avatar>\n\n            <h2 item-title>{{item.title}}</h2>\n\n            <h3 item-subtitle text-wrap>{{item.subtitle}}</h3>\n\n            <ion-badge item-end class="badge-dark">{{item.follow}}</ion-badge>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/prj666-g1/src/pages/tab-page-5/tab-page-5.html"*/,
