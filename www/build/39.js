...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tab_page_9__ = __webpack_require__(912);
...
var TabPage9 = (function () {
    ...
    TabPage9 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/pages/tab-page-9/tab-page-9.html"*/'<!--- Settings TAB lauout-9 -->\n\n<ion-content>\n\n    <ion-grid no-padding *ngIf="params != null">\n\n        <ion-row>\n\n            <ion-col col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 tabPage9 *ngFor="let item of params.items; let i = index;" (click)="onItemClick(item)">\n\n                <ion-card text-left>\n\n                    <div card-image>\n\n                        <img [src]="item.cardImage" />\n\n                        <ion-badge ion-fixed item-end class="badge-dark">{{item.price}}</ion-badge>\n\n                        <!-- Share Button -->\n\n                        <button ion-fixed item-end ion-button button-action-shit (click)="onShare(item, $event)">\n\n                          <ion-icon name="{{item.shareIcon}}"></ion-icon>\n\n                        </button>\n\n                    </div>\n\n                    <!--Card descriptiom-->\n\n                    <ion-card-content>\n\n                        <ion-card-title>\n\n                            <h2 card-title>{{item.title}}</h2>\n\n                            <h1 card-subtitle>{{item.subtitle}}</h1>\n\n                            <p card-body-text>{{item.description}}</p>\n\n                        </ion-card-title>\n\n                    </ion-card-content>\n\n                </ion-card>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-grid>\n\n</ion-content>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/pages/tab-page-9/tab-page-9.html"*/,
