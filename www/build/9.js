...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_select_layout_1_select_layout_1_module__ = __webpack_require__(599);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_select_layout_2_select_layout_2_module__ = __webpack_require__(600);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_select_layout_4_select_layout_4_module__ = __webpack_require__(602);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_select_layout_5_select_layout_5_module__ = __webpack_require__(603);
...
var SelectLayout1 = (function () {
    ...
    SelectLayout1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'select-layout-1',template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-1/select.html"*/'<ion-item *ngIf="data != null">\n\n    <ion-label>{{data.title}}</ion-label>\n\n    <ion-select [(ngModel)]="data.selectedItem" multiple="false">\n\n        <ion-option *ngFor="let item of data.items; let i= index" [value]="item.id">{{item.title}}</ion-option>\n\n    </ion-select>\n\n</ion-item>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-1/select.html"*/
        }),
...
var SelectLayout2 = (function () {
    ...
    SelectLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'select-layout-2',template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-2/select.html"*/'<ion-item *ngIf="data != null">\n\n    <ion-label>{{data.title}}</ion-label>\n\n    <ion-select [(ngModel)]="data.selectedItem" multiple="false" interface="popover">\n\n        <ion-option *ngFor="let item of data.items; let i= index" [value]="item.id">{{item.title}}</ion-option>\n\n    </ion-select>\n\n</ion-item>\n\n'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-2/select.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], SelectLayout2);
...
var SelectLayout5 = (function () {
    ...
    SelectLayout5 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'select-layout-5',template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-5/select.html"*/'<ion-item *ngIf="data != null">\n\n    <ion-label>{{data.title}}</ion-label>\n\n    <ion-select [(ngModel)]="data.selectedItem" multiple="true" interface="action-sheet">\n\n        <ion-option *ngFor="let item of data.items; let i= index" [value]="item.id">{{item.title}}</ion-option>\n\n    </ion-select>\n\n</ion-item>'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-5/select.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], SelectLayout5);
...
var SelectLayout6 = (function () {
    ...
    SelectLayout6 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'select-layout-6',template:/*ion-inline-start:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-6/select.html"*/'<ion-item *ngIf="data != null">\n\n    <ion-label>{{data.title}}</ion-label>\n\n    <ion-select interface="popover" [(ngModel)]="data.selectedItemMonth" multiple="true">\n\n        <ion-option *ngFor="let item of data.itemsMonth; let i= index" [value]="item.id">{{item.title}}</ion-option>\n\n    </ion-select>\n\n\n\n    <ion-select interface="popover" [(ngModel)]="data.selectedItemYear" [multiple]="true">\n\n        <ion-option *ngFor="let item of data.itemsYears; let i= index" [value]="item.id">{{item.title}}</ion-option>\n\n    </ion-select>\n\n</ion-item>'/*ion-inline-end:"/Users/xoxo/Downloads/codecanyon/src/components/select/layout-6/select.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], SelectLayout6);
